...
//		}
	...
	//This function below is to return a enemy in order to access it in the battle class 
	// and levelpane and pause(battlepane)
	...
	public boolean canMove(Character c, Space newSpace) {
		...
		if(board[newSpace.getRow()][newSpace.getCol()] == null && 
				newSpace.getRow() > 0 && 
				newSpace.getRow() < getNumRows() && 
				newSpace.getCol() > 0 && 
				newSpace.getCol() < getNumCols()) {
			return true;
		}
		else
			return false;
